...
fruits.forEach((element, index) => {
  if(element.color === "red"){
    console.log(`The fruit with idex ${index} is an apple`)
...
/*
  ...
  The ftuit with index 0 is neither apple or orange
  The fuit with index 1 is an orange
  The ftuit with index 2 is neither apple or orange
  The fruit with idex 3 is an apple
...
// CODE HERE
const riceTags = foods.filter((element) => element.tags.includes("rice")).reduce((acc, curr) => acc + curr.price, 0)

// THE TOTAL
console.log(riceTags)
//36
